...
public class RectangleZoneBound implements ZoneBound {
    ...
    private int eastBound, westBound, northBound, southBound;
     ...
     * @param zone The zone to which to apply boundries
     */
     ...
     * @param eastBound the east limit
     * @param westBound the west limit
     * @param northBound the north limit
     * @param southBound the south limit
     */
